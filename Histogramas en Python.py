...
import os
os.chdir('G:\Mi unidad\1_clases\1_MCD_PrograPython\_Material\sesion_1')
...
atletas = pd.read_csv('categorias_de_corredores.csv', sep=';', index_col=0) #Con index_col=0 le indicamos que las filas tienen un nombre
atletas.info()
...
plt.title("Gráfico de Barras Género")
